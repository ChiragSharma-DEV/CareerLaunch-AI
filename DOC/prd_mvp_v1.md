...
*   **State 2 (Data Bound):** Reached when the candidate intelligence is gathered. This is unlocked by *either* (a) Uploading a Resume (State 1) and verifying a public GitHub repository, OR (b) Auditing a LinkedIn Profile. Once reached, transitions the application to State 2, unlocking Tab 2.
...
### 5.1 Epic 1: Profile Auditor (Resume & GitHub & LinkedIn)
...
#### Feature 1.4: LinkedIn Sync and Profile Auditor Agent
*   **Description:** Allow candidates to audit their LinkedIn profile via the LinkedInProfileAuditorAgent to verify and structure headline SEO, about section narratives, and experience bullet points.
*   **Acceptance Criteria:**
    *   *Given:* The app is in State 0 or State 1.
    *   *When:* The user enters their LinkedIn URL and profile text under the LinkedIn Sync tab and clicks 'Audit LinkedIn Profile'.
    *   *Then:* The LLaMA-3.1 model parses details, returns detailed sub-scores and improvement checklists, syncs the parsed skills to the unified candidate profile, and transitions the app to State 2.

#### Feature 1.5: LinkedIn Audit Report PDF Download
*   **Description:** Allow users to export a formatted PDF report of the LinkedIn audit.
*   **Acceptance Criteria:**
    *   *Given:* The LinkedIn Profile Audit has completed.
    *   *When:* The user clicks 'Download Audit PDF'.
    *   *Then:* The jsPDF library compiles sub-scores, critiques, and checklist recommendations, and saves the PDF file.
